...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 02-01-01 | 01 | 1 | DATA-07 | unit | `npx vitest run src/__tests__/contacts/dedup.test.ts` | Wave 0 | pending |
| 02-01-02 | 01 | 1 | DATA-01 | unit | `npx vitest run src/__tests__/trigger/meeting-dispatcher.test.ts` | Wave 0 | pending |
| 02-02-01 | 02 | 2 | DATA-03-06 | unit | `npx vitest run src/__tests__/ai/extract-contacts.test.ts` | Wave 0 | pending |
| 02-02-02 | 02 | 2 | DATA-02 | unit | `npx vitest run src/__tests__/api/meetings-process.test.ts` | Wave 0 | pending |
| 02-03-01 | 03 | 2 | CONT-01-04 | unit | `npx vitest run src/__tests__/components/contact-card.test.tsx` | Wave 0 | pending |
| 02-03-02 | 03 | 2 | CONT-05-07 | unit | `npx vitest run src/__tests__/components/contact-form.test.tsx` | Wave 0 | pending |
